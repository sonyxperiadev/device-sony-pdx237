...
ifneq (,$(filter %xqde54,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := XQ-DE54
else
TARGET_BOOTLOADER_BOARD_NAME := XQ-DE54
...
# Kernel cmdline
BOARD_BOOTCONFIG += androidboot.hardware=pdx237
BOARD_KERNEL_CMDLINE += androidboot.fstab_suffix=pdx237
